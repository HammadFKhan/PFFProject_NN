...
def init_params(wd):
    ...
    param_file = wd + '\\input\\biophys_l23.json'
    tree = wd + '\\input\\rc19.hoc'
    N_e = 800  # number of excitatory synapses
    N_i = 200  # number of inhibitory synapses
    soma = [0]
    basal = [6, 16, 17, 22, 23, 30, 31, 34, 37, 40, 41, 42, 46, 47]
    oblique = [54, 57, 79]
    apical = [62, 63, 64, 65, 67, 70, 72, 73]
    # locs_e = np.array(
    ...
    E_r = -75.  # resting/leak reversal potential (mv)
